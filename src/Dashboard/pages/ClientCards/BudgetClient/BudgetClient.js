...
export default function BudgetRequestForm() { // Alterando o nome da função para BudgetRequestForm
  ...
  const handleSubmit = (event) => {
    ...
    // Adicione lógica para enviar o pedido de orçamento ao fornecedor aqui
    // Pode redirecionar para uma página de confirmação ou outra rota se necessário
    navigate('/orcamento-enviado'); // Redirecionando para uma rota após o envio do orçamento
  };
